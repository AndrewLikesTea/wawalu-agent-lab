ALTER TABLE lead_submissions RENAME TO lead_submissions_legacy_0009;
...
INSERT INTO lead_submissions (email, purpose, created_at)
  SELECT email, purpose, created_at FROM lead_submissions_legacy_0009;

DROP TABLE lead_submissions_legacy_0009;
