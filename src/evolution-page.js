...
async function init() {
  ...
  // redirected: the department region is opened, selected and focused, and a
  // slug this analysis does not hold says so in one sentence inside the region
  // instead of substituting somebody else's numbers.
  applyForwardedDepartment(document, { search: window.location?.search });
  ...
  async function loadAndRender() {
    ...
    applyForwardedDepartment(document, { search: window.location?.search, move: false });
