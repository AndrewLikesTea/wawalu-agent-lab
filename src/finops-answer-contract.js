...
// #1499's attestation came out here (#1700): it re-read, as a second published
// sentence, a headline that buildEvolutionFinding now states once over this
// file's own getRecoverableSpend record. The drift it guarded against is caught
// where it matters instead — scripts/check-finops-first-screen.mjs compares the
// BUILT document's headline with that contract's own primary benchmark.
