...
export const ANSWER_SPINE = Object.freeze([
  ...
  },
  {
    id: "plan-scope",
    role: ROLE.detail,
    question: "Which of these moves are you committing to, and at what scope?",
    headingId: "plan-scope-title",
  },
  {
    id: "routing-slate",
    role: ROLE.detail,
    question: "Which model routing changes should we ship this month?",
