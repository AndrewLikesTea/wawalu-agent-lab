...
// that path used, taken off the slate's own `pricing` record: declared when
// every line was priced off the reader's card, and the published list otherwise.
// Saying "declared" over a list-priced figure is the specific dishonesty #1286
// named, and `basisFor` is the only place the word is chosen.
//
 ...
 * else. An envelope that carries no record at all is the undeclared case — the
 ...
 * catches a non-finite modelled figure paired with a zero scope, where the
 * multiplication would be NaN and the total would stop being a number at all.
 */
 ...
 *   with the scope fraction #1286's levers resolved to. Moves that are not
 *   in-plan are dropped here and counted nowhere.
