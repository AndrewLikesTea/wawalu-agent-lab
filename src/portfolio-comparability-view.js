...
export function applyPortfolioComparability(doc, evaluated, { onJump } = {}) {
  ...
  // The action is a control only when there is something to do. A button that
  // says "no action needed" is a button that trains a reader to press past the
  // verdict.
  if (result.nextAction.code !== NO_ACTION_CODE) {
