...
export const COACHING_LOCAL_ONLY_BOUNDARY = Object.freeze([
  ...
  Object.freeze({
    ...
    claim: "No request is sent for coaching. The grading runs in this browser tab, on code that shipped with the page, and the form has no action to submit to.",
  ...
  Object.freeze({
    ...
    claim: "Nothing you paste is saved. The text is read from the field, measured, and left there — it is not stored, exported, or put in a URL.",
