...
export const COACHING_LOCAL_ONLY_BOUNDARY = Object.freeze([
  ...
  Object.freeze({
    ...
    claim: "No request is sent for coaching. Grading runs in this browser tab, and the form has no action to submit to.",
  ...
  Object.freeze({
    ...
    claim: "Nothing you paste is stored. The text you type is read from the field, measured, and left in the field — it is not saved, exported, or put in a URL.",
