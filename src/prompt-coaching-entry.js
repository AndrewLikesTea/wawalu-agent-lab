...
export const COACHING_ENTRY_EXAMPLE = Object.freeze({
  ...
  transition: Object.freeze({
    ...
    onClear: "Clear prompt and grades empties the field, drops the grades given to it and the comparison they set up, and returns the front door to its zero-input state, where the bundled synthetic example is offered again.",
