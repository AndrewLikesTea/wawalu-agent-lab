...
// The pages say these two words back to the reader ("Select Open post to see a
// post on its own page…"), so a second wording on one surface would leave that sentence
