...
function renderPostCard(post, { index }) {
  ...
  if (image) {
    ...
    const descriptionId = `post-${index}-image-description`;
    const media = renderMedia(image, description, descriptionId);
    const figcaption = el("figcaption", "post-image-description", `Image description: ${description.alt}`);
