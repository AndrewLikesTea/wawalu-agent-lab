...
test("the first load reserves a skeleton grid instead of a blank panel", () => {
  ...
  assert.equal(status.textContent, "Image posts are loading. Go to Social to publish an image post.");
...
test("the waiting line names image posts once without duplicating the selected display name", () => {
  assert.equal(loadingSummaryText(), "Image posts are loading. Go to Social to publish an image post.");
  assert.equal(loadingSummaryText("Zed"), "Image posts are loading. Go to Social to publish an image post.");
});
...
test("the profile page's static copy does not drift from the module's", async () => {
  ...
  assert.equal(loadingSummaryText("Ari"), "Image posts are loading. Go to Social to publish an image post.");
