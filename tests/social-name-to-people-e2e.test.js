...
test("a settled Social post carries its display name as a link to People, in the post's own reading order", async (t) => {
  ...
  // The card now starts with the display name, then its post text, image
  // description, metadata, and final action.
  ...
  assert.ok(at(link) < at(caption), "the display name did not lead the post");
